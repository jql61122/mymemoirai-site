          ...
          <div className="space-y-20">
            {steps.map((step, index) => (
              <FadeInWhenVisible key={step.key} delay={index * 0.2}>
                <div
                  className={`${
                    index % 2 === 0 ? "bg-[#F2EBE1]" : "bg-[#E8DFD2]"
                  } border border-gray-200 rounded-2xl shadow-sm p-8 md:p-12`}
                >
                  <div
                  ...
                  >
                    ...
                    {/* Text */}
                    <div className="w-full md:w-1/2 text-center md:text-left max-w-prose">
